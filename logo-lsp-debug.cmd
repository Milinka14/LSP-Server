...
echo [logo-lsp] Starting %date% %time%>>"target\logo-lsp-stderr.log"

java -cp "target\classes;target\dependency\*" com.logo.lsp.LogoLspLauncher 2>>"target\logo-lsp-stderr.log"
